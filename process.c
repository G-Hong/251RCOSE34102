...
// Process scenario_processes[] = {
//     {1,  "vim",     2, 15, 8, 0, 0, 0, 0, 0, 0, 0},
//     {2,  "top",     4, 9,  5, 0, 0, 0, 0, 0, 0, 0},
//     {3,  "chrome",  8, 15, 3, 0, 0, 0, 0, 0, 0, 0},
//     {4,  "firefox", 4, 15, 8, 0, 0, 0, 0, 0, 0, 0},
//     {5,  "init",    7, 15, 6, 0, 0, 0, 0, 0, 0, 0},
//     {6,  "apt",     8, 11, 8, 0, 0, 0, 0, 0, 0, 0},
//     {7,  "nano",    8, 5,  10,0, 0, 0, 0, 0, 0, 0},
//     {8,  "zsh",     8, 7,  2, 0, 0, 0, 0, 0, 0, 0},
//     {9,  "sshd",    8, 12, 1, 0, 0, 0, 0, 0, 0, 0},
//     {10, "code",    7, 10, 7, 0, 0, 0, 0, 0, 0, 0}
// };
